...
hidden: true
description: "Legacy 5-minute quickstart guide for executing the query-string-based Meld Checkout flow for the first time. Kept for reference; new integrations should follow the current quickstart."
---
...
**See the [URL parameters guide](/docs/stablecoins/meld-checkout-integration/meld-checkout-guide/url-parameters) for all available parameters and options.** **See the [Customization guide](/docs/stablecoins/meld-checkout-integration/meld-checkout-guide/meld-checkout-customization) for all available styling options.**

---
title: "Full Integration Guide (Legacy)"
sidebarTitle: "Full Integration Guide"
hidden: true
description: "Legacy full end-to-end integration guide for the query-string-based Meld Checkout flow. Kept for reference; new integrations should follow the current guide."
---

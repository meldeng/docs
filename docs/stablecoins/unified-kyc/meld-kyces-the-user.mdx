...
```json
{
  ...
  "id": "WmYumpKThCLWdgdK4fu2oh", // customerId to pass into /widget
  "key": "N/A",
...
```json
{
  ...
  "externalCustomerId": "testUser1",
	...
	"serviceProviderCustomers": [
		{
			"serviceProvider": "SUMSUB",  // sample KYC provider
...
_Note that Sumsub is being used as the sample KYC provider in these requests._
...
The response will include a `url` that you should then launch from your UI. The response will look like this:

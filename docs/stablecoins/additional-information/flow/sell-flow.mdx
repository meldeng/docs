...
|  | **\<div style={{ textAlign: "center" }}\>Retail Off-Ramp Support**<br />**(Sell Crypto)** |
| :-- | :-- |
| **Alchemy Pay** | \<div style={{ textAlign: "center" }}\> Standard Flow |
| **Banxa** | \<div style={{ textAlign: "center" }}\> Preferred Flow |
| **Coinbase Pay** | \<div style={{ textAlign: "center" }}\> Preferred Flow |
| **Koywe** | \<div style={{ textAlign: "center" }}\> Standard Flow |
| **OnMeta** | \<div style={{ textAlign: "center" }}\> Preferred Flow |
| **Paybis** | \<div style={{ textAlign: "center" }}\> Standard Flow |
| **Robinhood Connect** | \<div style={{ textAlign: "center" }}\> Preferred Flow |
| **Transak** | \<div style={{ textAlign: "center" }}\> Preferred and Standard Flow |
| **TransFi** | \<div style={{ textAlign: "center" }}\> Standard Flow |
| **Unlimit** | \<div style={{ textAlign: "center" }}\> Preferred and Standard Flow |

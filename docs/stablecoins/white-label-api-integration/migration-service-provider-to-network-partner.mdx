...
<Note>
The legacy `/service-providers/properties/*` and `/service-providers/limits/fiat-currency-purchases` endpoints are still live and fully functional — they are deprecated and being phased out in favor of the Network Partner API, not removed. You can migrate on your own timeline.
</Note>

...
The best KYC provider to test with in sandbox is Sumsub. Therefore, this page uses Sumsub for the KYC examples. Talk to your account manager to have Sumsub set up for your Meld account.
...
Brale **is not** supported in sandbox.
...
The features discussed in this section relate to buy quotes specifically, and at this time are not available for sell quotes. All of the data discussed in this section is returned from the [quote endpoint](/api-reference/crypto/retail-ramp/crypto-quote-get). 

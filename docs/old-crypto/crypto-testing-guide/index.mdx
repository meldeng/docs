...
This page is for how to test the buy flow using onramp's sandboxes. To test the sell, transfer, or NFT Checkout flow, see [here](/docs/old-crypto/crypto-testing-guide/testing-sell-transfer-and-nft-checkout).
...
On this page you will find testing information for [Unlimit](/docs/old-crypto/crypto-testing-guide#unlimit), [Banxa](/docs/old-crypto/crypto-testing-guide#banxa), [BTC Direct](/docs/old-crypto/crypto-testing-guide#btc-direct), [Simplex](/docs/old-crypto/crypto-testing-guide#simplex), [TransFi](/docs/old-crypto/crypto-testing-guide#transfi), [Transak](/docs/old-crypto/crypto-testing-guide#transak), [Sardine](/docs/old-crypto/crypto-testing-guide#sardine), [Onramp Money](/docs/old-crypto/crypto-testing-guide#onramp-money), [Fonbnk](/docs/old-crypto/crypto-testing-guide#fonbnk), [Paybis](/docs/old-crypto/crypto-testing-guide#paybis), [Koywe](/docs/old-crypto/crypto-testing-guide#koywe), [Robinhood](/docs/old-crypto/crypto-testing-guide#robinhood), [Coinbase Pay](/docs/old-crypto/crypto-testing-guide#coinbase-pay), [Blockchain.com](/docs/old-crypto/crypto-testing-guide#blockchaincom), [Stripe](/docs/old-crypto/crypto-testing-guide#stripe), [Alchemy Pay](/docs/old-crypto/crypto-testing-guide#alchemy-pay), and [Mercuryo](/docs/old-crypto/crypto-testing-guide#mercuryo).
...
Use the following test values when testing in [Meso\`s](https://meso.network/) sandbox.

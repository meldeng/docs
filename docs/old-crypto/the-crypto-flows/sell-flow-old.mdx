...
Here is an example of the corresponding call to [/widget](/api-reference/crypto/retail-ramp/crypto-session-widget-create) when selling cryptocurrency (note that unlike the Buy call, the wallet address shouldn't be passed here):

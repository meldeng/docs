...
| :------------------------ | :-------------------------------------------------------- | :-------------------------------------------------------------------------------------------------------------- |
| Balances / Owners / IDs   | `GET /bank-linking/accounts`                    | [Retrieving Connection Data](/docs/bank-linking/get-connection-data/retrieving-connection-data)                 |
...
| Investment Holdings       | `GET /bank-linking/investments/holdings`                   | [Retrieving Connection Data](/docs/bank-linking/get-connection-data/retrieving-connection-data)                 |
| Investment Transactions   | `GET /bank-linking/investments/transactions`               | [Retrieving Connection Data](/docs/bank-linking/get-connection-data/retrieving-connection-data)                 |

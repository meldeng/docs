...
- **Service Provider** — The entity responsible for completing a connection between a user and a bank account. Plaid, Finicity, MX, Yodlee, Salt Edge, and Salt Edge Partners are all service providers.

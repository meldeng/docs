...
- **Service Provider** — The entity responsible for completing a connection between a user and a bank account. Plaid, Finicity, MX, Salt Edge, and Salt Edge Partners are all service providers.
